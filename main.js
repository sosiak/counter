...
IsSafari();
const defaultMainInput = defaultInputValue('time-input');
const convertedDefaultValue = convertDefaultInputValue(defaultMainInput);
let bigCalculate = currentInputValue('time-input', 'destination-time__error');
